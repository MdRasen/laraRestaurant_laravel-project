...
@section('title', 'laraRestaurant - Edit Team')
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fb_link" value="{{ $team->fb_link }}"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="twitter_link"
                                        value="{{ $team->twitter_link }}" placeholder="https://www.twitter.com">
                                    <p style="color:red;">
                                        @error('twitter_link')
                                            *{{ $message }}
                                        @enderror
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="insta_link"
                                        value="{{ $team->insta_link }}" placeholder="https://www.instagram.com">
                                    <p style="color:red;">
                                        @error('insta_link')
                                            *{{ $message }}
                                        @enderror
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="Hidden" {{ $team->status == 'Hidden' ? 'selected' : '' }}>Hidden
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-primary mr-2">Update Team</button>
